...
function setup() {
	...
	particle1 = Bodies.circle(220,10,10,balls);
	World.add(world,particle1);

	particle2 = Bodies.circle(220,10,10,balls);
	World.add(world,particle2);
	
	particle3 = Bodies.circle(225,10,10,balls);
	World.add(world,particle3);

	particle4 = Bodies.circle(230,10,10,balls);
	World.add(world,particle4);

	particle5 = Bodies.circle(230,10,10,balls);
